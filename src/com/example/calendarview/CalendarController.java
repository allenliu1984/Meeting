...
public class CalendarController {
    ...
    public interface EventType {
        ...
        final int VIEW_EVENT_DETAILS = 3;

        // full detail view in edit mode
        final int EDIT_EVENT = 4;
        final int DELETE_EVENT = 5;
        final int GO_TO = 6;
        final int LAUNCH_SETTINGS = 7;
        final int EVENTS_CHANGED = 8;
        final int SEARCH = 9;
        // User has pressed the home key
        final int USER_HOME = 10;

        // date range has changed, update the title
        final int UPDATE_TITLE = 11;

        // select which calendars to display
        final int LAUNCH_SELECT_VISIBLE_CALENDARS = 12;
    }
    ...
    public static class EventInfo {
        ...
        public int eventType; // one of the EventType
